...
namespace OncuService.Common.Infrastructure;
...
public static class QueueFactory
{
    ...
    public static EventingBasicConsumer CreateBasicConsumer()
    {
        ...
        {
            HostName = OncuServiceConstants.RabbitMQHost,
            UserName = OncuServiceConstants.RabbitMQUser,
            Password = OncuServiceConstants.RabbitMQPass
        };
    ...
    public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer, string exchangeName, string exchangeType = OncuServiceConstants.DefaultExchangeType)
    {
